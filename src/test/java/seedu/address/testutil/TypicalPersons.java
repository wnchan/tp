...
public class TypicalPersons {
    ...
    public static final Person ALICE = new PersonBuilder().withName("Alice Pauline").withMajor("Computer Science")
            .withYear("2").withEmail("alice@u.nus.edu").withDescription("web dev").withTutorials("01", "02")
            .withSocialMediaLinks("https://www.linkedin.com/in/alice").build();
    public static final Person BENSON = new PersonBuilder().withName("Benson Meier").withMajor("Computer Science")
            ...
            .withSocialMediaLinks("https://www.linkedin.com/in/benson", "https://github.com/benson").build();
    public static final Person CARL = new PersonBuilder().withName("Carl Kurz").withMajor("Computer Science")
            .withYear("2").withEmail("heinz@u.nus.edu").withDescription("fe dev").withTutorials("05", "06").build();
    public static final Person DANIEL = new PersonBuilder().withName("Daniel Meier").withMajor("Computer Science")
            .withYear("2").withEmail("cornelia@u.nus.edu").withDescription("be dev").withTutorials("07", "08")
            .withSocialMediaLinks("https://www.linkedin.com/in/daniel").build();
    public static final Person ELLE = new PersonBuilder().withName("Elle Meyer").withMajor("Computer Science")
            .withYear("2").withEmail("werner@u.nus.edu").withDescription("fe dev").withTutorials("09", "10").build();
    public static final Person FIONA = new PersonBuilder().withName("Fiona Kunz").withMajor("Computer Science")
            .withYear("2").withEmail("lydia@u.nus.edu").withDescription("be dev").withTutorials("11", "12").build();
    public static final Person GEORGE = new PersonBuilder().withName("George Best").withMajor("Computer Science")
            .withYear("2").withEmail("anna@u.nus.edu").withDescription("fe dev").withTutorials("13", "14").build();

    // Manually added
    public static final Person HOON = new PersonBuilder().withName("Hoon Meier").withMajor("Computer Science")
            .withYear("2").withEmail("stefan@u.nus.edu").withDescription("web dev").withTutorials("15", "16").build();
    public static final Person IDA = new PersonBuilder().withName("Ida Mueller").withMajor("Computer Science")
            .withYear("2").withEmail("hans@u.nus.edu").withDescription("mobile dev").withTutorials("17", "18").build();
