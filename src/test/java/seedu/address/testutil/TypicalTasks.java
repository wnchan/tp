...
public class TypicalTasks {
    ...
    public static final Task CS2101_OP1_UPLOAD = new Task("Upload video of OP1.", TaskStatus.NOT_DONE,
    ...
    public static final Task CS2101_RESEARCH_SCQA = new Task("Research on  SCQA framework.", TaskStatus.NOT_DONE,
        TaskModule.CS2101, "TODO", "");
    ...
    public static final Task CS2103T_RELEASE_JAR = new Task("Release v1.3.trial jar file.", TaskStatus.NOT_DONE,
    ...
    public static final Task CS2103T_FINALISE_TP = new Task("Finalise TP.", TaskStatus.NOT_DONE,
